...
if goto_tab "Профиль" 5 "Аналитика" "перешёл в профиль"; then
    ...
    if step "Кабинеты" "нажал «Кабинеты» в группе «Практика»"; then
        sleep 1
        shot "cabinets-A08" 3
        ...
        # проверка проходила бы и не открыв экран.
        if has_text "Места, куда вы зовёте клиентов" || scroll_to_text "Места, куда вы зовёте клиентов" 3; then
