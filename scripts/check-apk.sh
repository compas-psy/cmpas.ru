...
if [ -z "$TREE" ]; then
    ...
    echo "  Яндекс ID, идентификатор приложения: ${YANDEX_ID:+$(short_value "$YANDEX_ID")}${YANDEX_ID:-нет в манифесте}"
    echo "  ВК, идентификатор приложения:        ${VK_ID:+$(short_value "$VK_ID")}${VK_ID:-нет в манифесте}"
