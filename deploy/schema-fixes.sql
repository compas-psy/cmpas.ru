...
-- ============================================================
-- Mobile API: FCM push, scheduled messages, client invite tokens
-- (added 2026-06-10; prisma migrate deploy is unavailable in the
--  runtime container, so these idempotent statements apply the
--  schema via psql instead)
-- ============================================================
