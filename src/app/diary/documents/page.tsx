...
export default function DocumentsPage() {
    return (
        <div className="space-y-8 pb-12">
            <div>
                <h1 className="text-[40px] font-bold tracking-tight text-foreground leading-[44px]">Документы</h1>
                <p className="text-muted-foreground text-[15px] mt-2">Шаблоны, подписание и юридическая безопасность в практике психолога</p>
            </div>
            <div className="flex flex-col items-center justify-center py-24 px-8">
                ...
                <p className="text-body-secondary text-muted-foreground text-center max-w-md">
                    Шаблоны согласий, договоров и актов. Переменные, предпросмотр,
                    отправка клиентам и отслеживание статусов подписания.
                </p>
