    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-[#64748b] text-sm mt-0.5">Нажатия «Хочу первым» в приложении.</p>
            </div>

            {/* ЭКРАН ГОВОРИТ, ЧЕГО ОН НЕ ВИДИТ.
                Дефект У10 книги учредителя. В подписи стояло «из Android/web»,
                а веб-точки голосования нет вовсе: кнопку показывает только
                приложение. Решение о том, что строить дальше, принимается по
                числу голосов — и если половина людей физически не может
                проголосовать, число говорит не о спросе, а о том, у кого стоит
                приложение. Выглядит оно при этом совершенно так же. */}
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-900">
                <b>Здесь видно только тех, у кого стоит приложение.</b> В веб-кабинете кнопки
                «Хочу первым» нет, поэтому числа ниже — не весь спрос, а его часть. Сравнивать
                функции между собой по ним можно, судить о размере спроса — нет.
            </div>
