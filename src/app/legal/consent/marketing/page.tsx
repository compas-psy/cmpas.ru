...
import { OPERATOR_EMAIL, OPERATOR_INN, OPERATOR_OGRNIP, SERVICE_NAME } from '@/lib/legal/operator';

export const metadata: Metadata = {
    title: `Согласие на получение рекламных сообщений — ${SERVICE_NAME}`,
    description: `Согласие на получение рекламных сообщений ${SERVICE_NAME}, версия 2.0 от 01 сентября 2025 года.`,
};
            ...
            <div className="container mx-auto px-4 py-16 max-w-3xl">
                ...
                <div className="prose prose-sm max-w-none text-foreground/90 space-y-6">
                    <section>
                        ...
                        <p>1.1. Настоящее Согласие (далее — «Согласие») регулирует порядок получения рекламных сообщений от онлайн-сервиса {SERVICE_NAME}, принадлежащего индивидуальному предпринимателю, ОГРНИП {OPERATOR_OGRNIP}, ИНН {OPERATOR_INN}, адрес электронной почты <a href={`mailto:${OPERATOR_EMAIL}`} className="text-primary hover:underline">{OPERATOR_EMAIL}</a> (далее — «Оператор»).</p>
                        ...
                        <p>1.3. Рекламные сообщения направляются {SERVICE_NAME} только при наличии действующего Согласия, оформленного в соответствии со статьёй 18 Федерального закона № 38-ФЗ «О рекламе».</p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc ml-6 space-y-1">
                            <li>уведомления о новых функциях и возможностях {SERVICE_NAME};</li>
                            <li>предложения об участии в вебинарах, обучающих программах, акциях;</li>
                            <li>новости и рекомендации, связанные с деятельностью {SERVICE_NAME} и партнёров.</li>
                        </ul>
                        ...
                        <ul className="list-disc ml-6 space-y-1">
                            ...
                            <li>push-уведомления в Telegram MiniApp {SERVICE_NAME};</li>
                            <li>SMS-сообщения (в случае предоставления номера телефона).</li>
                        </ul>
                        <p>2.3. {SERVICE_NAME} не направляет SMS-рекламу без отдельного подтверждения Клиента.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <ul className="list-disc ml-6 space-y-1">
                            <li>установлением чек-бокса «Согласен(на) на получение рекламных сообщений {SERVICE_NAME}» при регистрации или в профиле;</li>
                            <li>нажатием кнопки «Получать новости {SERVICE_NAME}» в интерфейсе Telegram MiniApp;</li>
                            <li>подпиской на рассылку по ссылке {SERVICE_NAME}, где содержится активное действие пользователя.</li>
                        </ul>
                        <p>3.2. Согласие фиксируется в системе {SERVICE_NAME} в журнале обработки персональных данных с указанием:</p>
                        <ul className="list-disc ml-6 space-y-1">
                    ...
                    <section>
                        ...
                        <ul className="list-disc ml-6 space-y-1">
                            <li>снять отметку в профиле {SERVICE_NAME};</li>
                            <li>отправить сообщение в Telegram-бот {SERVICE_NAME} с командой «Отписаться»;</li>
                        ...
                        <p>4.2. После отзыва согласия {SERVICE_NAME} прекращает рассылку рекламных сообщений в течение 24 часов, за исключением сообщений, находящихся в стадии отправки.</p>
                    ...
                    <section>
                        ...
                        <p>5.2. {SERVICE_NAME} не передаёт данные третьим лицам для целей рекламы без отдельного письменного согласия субъекта данных.</p>
                        <p>5.3. Хранение информации о согласии осуществляется до момента его отзыва, после чего сведения удаляются из системы {SERVICE_NAME}.</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-semibold text-primary mt-8 mb-3">6. Ответственность сторон</h2>
                        <p>6.1. {SERVICE_NAME} несёт ответственность за соблюдение требований ФЗ-38 в части рассылки рекламы.</p>
                        ...
                        <p>6.3. {SERVICE_NAME} не несёт ответственности за задержки в доставке сообщений, вызванные действиями операторов связи или техническими сбоями.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>7.2. {SERVICE_NAME} ведёт учёт всех предоставленных и отозванных согласий в Журнале обработки персональных данных.</p>
