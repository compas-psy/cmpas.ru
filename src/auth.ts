    ...
    providers: [
        ...
        Nodemailer({
            ...
            sendVerificationRequest: async ({ identifier: email, url, provider }) => {
                ...
                // acc.provider === "yandex", а снятая теперь ручка экрана
                // входа считала аккаунтом ЛЮБОЙ провайдер кроме nodemailer,
                // то есть один и тот же вопрос получал два разных ответа в
