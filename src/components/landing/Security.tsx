...
export default function Security() {
    return (
        <section id="security" className="py-14 md:py-16 bg-white">
                ...
                <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16">
                    ...
                    <div className="lg:max-w-[400px] shrink-0">
                        ...
                        <p className="text-[15px] md:text-[16px] leading-[1.6] text-[#5F6C64]">
                            Данные клиентов требуют аккуратности. В&nbsp;ПРАКТИКЕ предусмотрены согласия, приватные заметки, контроль доступа и&nbsp;понятная логика обработки данных.
                        </p>
                    </div>
